...
<h2>customers Join 폼</h2>

<form action="${contextPath}/customers/join" method="post">

  <div class="container">
  	<label for="custId"><b>ID</b></label>
    <input type="text" placeholder="Enter UserID" name="custId" required>
    ...
    <input type="password" placeholder="Enter phoneNumber" name="phone" required>
